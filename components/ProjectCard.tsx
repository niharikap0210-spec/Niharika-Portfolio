...
export default function ProjectCard({
  ...
  return (
    ...
    >
      <Link
        href={`/work/${slug}`}
        className="group block rounded-2xl overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet/50 focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
        style={{
        ...
        onMouseEnter={(e) => {
          (e.currentTarget as HTMLElement).style.boxShadow =
            "0 2px 4px rgba(0,0,0,0.06), 0 12px 40px rgba(124,58,237,0.12)";
          (e.currentTarget as HTMLElement).style.transform = "translateY(-3px)";
          (e.currentTarget as HTMLElement).style.borderColor = "rgba(124,58,237,0.2)";
        }}
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLElement).style.boxShadow =
            "0 1px 2px rgba(0,0,0,0.04), 0 4px 16px rgba(124,58,237,0.05)";
      ...
      >
        ...
        <div
          ...
          style={{
            aspectRatio: "16/9",
            background: `hsl(${accentHue}, 60%, 96%)`,
          }}
        >
          <img
          ...
          <div
            ...
            style={{
              background: `hsl(${accentHue}, 80%, 40%)`,
            }}
          />
          {/* Year badge */}
          <span
        ...
        <div className="p-6">
          <div className="flex items-start justify-between gap-4 mb-2">
            <h3
              className="font-sans font-semibold text-ink-900 text-lg leading-snug"
