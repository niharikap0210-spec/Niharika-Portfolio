...
> = {
  biteback: {
    title: "BiteBack",
    subtitle:
      "Connecting surplus food with those in need through an intuitive donation platform.",
    year: "2024",
    ...
    overview:
      "BiteBack is a mobile platform designed to reduce food waste and promote food security by connecting local restaurants that have surplus food to individuals and organizations in need. It facilitates real-time food donation listings, enhances accessibility, and fosters a community-driven approach to responsible consumption.",
    problem:
      "Food donations lack accessibility, efficiency, and visibility — leading to missed opportunities for both donors and recipients. Every year, one-third of all food produced is wasted while 34 million people in the U.S. face hunger (USDA, 2023). Restaurants generate excess food, but logistics, liability concerns, and lack of streamlined donation systems prevent efficient redistribution.",
    problemStats: [
    ...
    researchHighlights: [
      {
        finding: "Access to surplus food is limited and inconsistent",
        quote:
          "Sometimes, I don't even know where to look for food donations. I hear about them too late, or they're too far away.",
      },
      {
        finding: "Logistics and time constraints hinder restaurant donations",
        quote:
          "We're already busy closing at night. Packing up donations and figuring out where to take them is just extra work.",
      },
      {
        finding: "Food safety and liability concerns create hesitation",
        quote:
          "I want to help, but I don't want to be responsible if something goes wrong with the food after it leaves my restaurant.",
      },
    ],
    process: [
    ...
    outcome:
      "SUS score improved from 72% to 86% across two testing rounds. Faster task completion with streamlined flows. Users appreciated personalized notifications, better item filtering, and the Rewards & Points system. The platform successfully addresses the core challenge of connecting surplus food donors with recipients in real time.",
    keyTakeaways: [
  ...
  locallift: {
    title: "LocalLift",
    subtitle:
      "Empowering small businesses with mentorship, digital tools, and community support.",
    year: "2024",
    role: "UX Researcher / Designer",
    ...
    researchHighlights: [
      {
        finding: "Small business owners need structured, specific mentorship",
        quote:
          "I don't just need motivation — I need someone who's actually been in my shoes to tell me exactly what works and what doesn't.",
      },
      {
        finding: "Digital tools must be simple and built for their context",
        quote:
          "There are so many digital tools out there, but they all feel like they're built for big companies. I need something straightforward.",
      },
      {
        finding: "Community support plays a crucial role in business success",
        quote:
          "I feel like I'm figuring everything out alone. If I could connect with other small business owners, I'd probably avoid making a lot of mistakes.",
      },
    ],
    process: [
      ...
      "Lo-Fi Wireframes: Structured key flows — onboarding, authentication, email verification, and profile navigation",
      "Hi-Fi Design + Iteration: 3 major design improvements based on user feedback, including cleaner card design, progress bars, and optimized search",
    ],
    outcome:
      "Users absorbed information 20% faster from the redesigned card interface. Users felt 20% less confused with the progress bar addition. Users found relevant results 40% faster after optimized search and filtering. The platform was designed to be inclusive and scalable across diverse entrepreneurs.",
    keyTakeaways: [
  ...
  thesis: {
    ...
    subtitle:
      "Redefining public spaces and reviving community life through human-centered architectural design.",
    year: "2023",
    ...
    overview:
      "An architectural thesis initiative exploring how underutilized urban spaces can be transformed into vibrant public areas that strengthen community interactions and improve quality of life. The project applies human-centered design principles from both architecture and UX to the challenge of public placemaking.",
    problem:
      "Urban spaces are increasingly underutilized — physically present but socially inert. Public areas that should naturally bring communities together instead sit empty, used at a fraction of their potential due to poor design, accessibility barriers, and a lack of intentional placemaking thinking.",
    process: [
      ...
      "3D Modeling & Visualization: Built detailed models in SketchUp and produced renderings in Lumion to communicate design intent",
      "Iteration: Refined design based on feedback from architectural review sessions",
    ],
    outcome:
      "A comprehensive architectural thesis demonstrating how placemaking and UX design share core priorities — accessibility, human-centered thinking, contextual understanding, and iterative refinement. The work established a foundation for my transition into digital product design.",
    keyTakeaways: [
  ...
  renders: {
    ...
    subtitle:
      "3D modeling and architectural visualization exploring how digital rendering communicates spatial design intent.",
    year: "2022",
    role: "Architect & Visualization Designer",
    team: "Individual project",
    duration: "Ongoing",
    tools: ["AutoCAD", "SketchUp", "Lumion", "Photoshop"],
    tags: ["3D Modeling", "Visualization", "Architecture", "Rendering"],
    overview:
      "A collection of architectural 3D modeling and visualization work demonstrating proficiency with industry-standard tools. The project explores how rendered imagery bridges the gap between architectural concept and built reality — communicating spatial experiences that drawings alone cannot.",
    problem:
      "Architectural drawings communicate plan and structure but fail to convey atmosphere, material quality, and the lived experience of a space. Visualization work fills this gap — translating abstract design intent into images that clients, communities, and collaborators can emotionally connect with.",
    process: [
    ...
    outcome:
      "A portfolio of architectural visualizations demonstrating technical proficiency and an eye for communicating spatial experience. This work sharpened my ability to think visually and translate design intent — skills that carry directly into my UX practice through wireframing and prototyping.",
    keyTakeaways: [
    ...
    <div className="pt-14">
      ...
      >
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-8 pt-16 pb-12">
          ...
          <motion.p
            variants={itemVariants}
            className="text-xl text-ink-500 mb-10 max-w-2xl"
          ...
          >
            {[
              ...
              <div key={meta.label}>
                <p
                  className="text-xs font-semibold uppercase tracking-widest text-ink-300 mb-1"
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap gap-2 mt-2">
            {project.tools.map((tool) => (
              <span
                key={tool}
                className="text-xs px-2.5 py-1 rounded-full text-ink-500"
                style={{
        ...
        >
          <div
            ...
            style={{
              aspectRatio: "16/7",
              background: `hsl(${project.accentHue}, 50%, 95%)`,
              border: "1px solid var(--ink-100)",
            }}
          >
            <img
              src={`https://placehold.co/1200x525/F5F3FF/7C3AED?text=`}
              alt={project.title}
            ...
            <div
              ...
              style={{ background: `hsl(${project.accentHue}, 80%, 40%)` }}
            />
          </div>
        </motion.div>
        ...
        <div className="max-w-5xl mx-auto px-6 md:px-8 pb-24">
          <div className="max-w-2xl mx-auto space-y-14">
            ...
            <motion.section variants={itemVariants}>
              <h2
                className="text-xs font-semibold uppercase tracking-widest text-ink-300 mb-4"
                style={{ letterSpacing: "0.1em" }}
              >
                Overview
              </h2>
              <p className="text-ink-700" style={{ lineHeight: "1.75" }}>
                {project.overview}
              </p>
            </motion.section>
            ...
            <motion.section variants={itemVariants}>
              ...
              <p className="text-ink-700 mb-5" style={{ lineHeight: "1.75" }}>
                {project.problem}
              </p>
                ...
                <div className="space-y-3 mt-4">
                  {project.problemStats.map((stat, i) => (
                    <div key={i} className="flex gap-3">
                      ...
                      />
                      <p className="text-sm text-ink-500" style={{ lineHeight: "1.65" }}>
                        {stat}
                      </p>
                    </div>
                  ))}
            ...
            {project.researchHighlights && (
              <motion.section variants={itemVariants}>
                <h2
                  className="text-xs font-semibold uppercase tracking-widest text-ink-300 mb-6"
                  style={{ letterSpacing: "0.1em" }}
                >
                  Research Findings
                </h2>
                <div className="space-y-4">
                  {project.researchHighlights.map((item, i) => (
                    ...
                    >
                      ...
                      <p
                        className="text-sm text-ink-500 italic"
              ...
              <ol className="space-y-4">
                {project.process.map((step, i) => (
                  <li key={i} className="flex gap-4">
                    ...
                    <p className="text-ink-700 pt-0.5" style={{ lineHeight: "1.65" }}>
                      {step}
                    </p>
                  </li>
                ))}
            ...
            <motion.div variants={itemVariants}>
              <div
                ...
                style={{
                  aspectRatio: "4/3",
                  background: `hsl(${project.accentHue}, 40%, 97%)`,
                  border: "1px solid var(--ink-100)",
                }}
              >
                <img
                  src={`https://placehold.co/800x600/F5F3FF/7C3AED?text=`}
                  alt="Design screens"
                  className="w-full h-full object-cover"
                />
              </div>
              <p className="text-xs text-ink-300 mt-3 text-center">
                Wireframes, prototypes, and final screens coming soon
              </p>
            </motion.div>
            ...
            <motion.section variants={itemVariants}>
              ...
              >
                <p className="text-ink-700 font-medium" style={{ lineHeight: "1.75" }}>
                  {project.outcome}
                </p>
              </div>
            </motion.section>
            ...
            <motion.section variants={itemVariants}>
              <h2
                className="text-xs font-semibold uppercase tracking-widest text-ink-300 mb-5"
                style={{ letterSpacing: "0.1em" }}
              >
                Key Takeaways
              </h2>
              <div className="space-y-3">
                {project.keyTakeaways.map((item, i) => (
                  <div key={i} className="flex gap-4">
                    <span
                      className="shrink-0 text-xs font-semibold text-violet mt-0.5"
                      style={{ minWidth: "1.25rem" }}
                    >
                      {String(i + 1).padStart(2, "0")}
                    </span>
                    <p className="text-sm text-ink-600" style={{ lineHeight: "1.65" }}>
                      {item}
                    </p>
                  </div>
                ))}
            ...
            >
              <Link
                href="/"
                className="inline-flex items-center gap-2 text-sm font-medium text-ink-500 hover:text-ink-900 transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet/40 rounded"
                style={{ transitionProperty: "color" }}
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  <path
              ...
              >
                ...
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                  <path
                    d="M2.5 7h9M9 3.5L12.5 7 9 10.5"
                    stroke="currentColor"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
